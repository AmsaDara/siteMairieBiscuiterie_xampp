...
<?php include 'templates/header.php';?>
    ...
    <h1 style="text-align: center;">Service Public</h1>
        <p>
    ...
    <h3 style="width: 100%; text-align: center; font-size: 30px; color: rgb(42, 42, 112);"> Liste des institution public de l'etat & les ONG au niveau de la commune</h3>
    <div class="institution">
        <div class="imgInstitution">
            <img src="image/logo.jpg" alt="">
        </div>
        <div class="contentInstitution">
            <h3>Nom de l'institution</h3>
            <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
            Ex non ut, nostrum distinctio laudantium velit adipisci nobis ipsa, 
            officia, fugiat tempora at! Eligendi aut eius nihil quasi deserunt 
            optio repellendus!
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
            Ex non ut, nostrum distinctio laudantium velit adipisci nobis ipsa, 
            officia, fugiat tempora at! Eligendi aut eius nihil quasi deserunt 
            ...
            <p><span>Adresse : </span> kfkfjkqknvkqfpqk <span>Numero Tel : </span> ruhiqovhqjjghghklf</p>
        </div>
    </div>
